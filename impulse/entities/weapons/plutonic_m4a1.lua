-- "addons\\plutonic\\lua\\weapons\\plutonic_m4a1.lua"
...
SWEP.WorldModel = Model("models/vj_weapons/w_csgo_m4a1.mdl")
SWEP.ViewModel = Model("")
SWEP.ViewModelFOV = 77
SWEP.UseHands=  true
SWEP.ViewModelOffset = Vector(2, 2, -1)
SWEP.ViewModelOffsetAng = Angle(0, -.4, 0)
...
SWEP.Primary.Damage = 9.1
SWEP.Primary.PenetrationScale = 0.2
...
SWEP.IronsightsPos = Vector(-4.541, -2.15, 1.5)
