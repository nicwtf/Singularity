-- "addons\\plutonic\\lua\\weapons\\plutonic_base\\client\\viewmodel.lua"
...
function SWEP:CalcView(ply, pos, ang, fov)
	...
	if self:GetReloading() then
		...
		--return pos, lerpAngle(self.CAM_ReloadAlp * ((vm:SequenceDuration() - (Curtime() - self.CAM_ReloadAct))/vm:SequenceDuration()), ang, n_ang or Angle(0,0,0)), fov
