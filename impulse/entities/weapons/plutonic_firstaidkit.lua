-- "addons\\plutonic\\lua\\weapons\\plutonic_firstaidkit.lua"
...
SWEP.CenteredPos = Vector(-13, 10, -3)
SWEP.CenteredAng = Angle(0, -45, 0)
...
function SWEP:PrimaryAttack()
	...
	if hp == ent:GetMaxHealth() then
		self.Owner:Notify("This player is fully healed already.")
		return
	end
	
	local give = math.Clamp(hp + 10, 0, ent:GetMaxHealth())
	ent:SetHealth(give)
	ent:ScreenFade(1, Color(201, 217, 242, 98), 1, 0)
